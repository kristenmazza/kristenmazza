...
Project | Description
--- | ---
| <img src="https://i.ibb.co/bKF6dWq/shopping-cart.png" alt="Shopping Cart screenshot" style="width: 300px;"/> | **Shopping Cart** <br/><br/> Mock-up of a shopping site with ability to browse products and add items to cart. Used React Router for "client-side routing" and a public API to retrieve product details. Conducted UI testing using Vitest (a testing framework) and React Testing Library. <br/><br/> [Live Demo](https://kristenmazza-shopping-cart.netlify.app/) :point_left:
